...
$(document).ready(function () {
  const input = prompt('Enter timer duration in mm:ss format:');
  const timeArray = input.split(':');
  console.log(timeArray[0]);
  var currentDate = new Date();
  var futureDate = new Date();
  futureDate.setMinutes(currentDate.getMinutes() + parseInt(timeArray[0]));
  futureDate.setSeconds(currentDate.getSeconds() + parseInt(timeArray[1]));
